...
3. **Settled on-chain**:USDC is transferred to the merchant
...
| Per-transaction fee | $0.001 USDC |
| On-chain gas | Covered by mag3nt |

**Example:** A $10 payment costs $0.051:merchant receives $9.949.
...
- **On-chain confirmation**: A few seconds on Solana/Base.
